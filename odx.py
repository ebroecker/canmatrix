...
if __name__ == '__main__':
    ...
    eo = OdxReader()
#    eo.open("Bootloader.odx")
    eo.open("PCM_MULTIJET_16V.odx")
...
#            if len(info_struct[mux_val][value]) > 2:
#                print(hex(mux_val), end='')
#                print(info_struct[mux_val][value])
...
#                print(info_struct[mux_val][value])
    ...
    canmatrix.formats.dumpp({"": db}, "aa.dbc")
