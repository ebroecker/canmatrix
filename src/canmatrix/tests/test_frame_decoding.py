...
def test_decode_with_dbc_big_endian():
    ...
    frame1 = cm.frame_by_id(canmatrix.Arbitration_Id(1))
...
def test_decode_with_dbc_little_endian():
    ...
    frame = cm.frame_by_id(canmatrix.Arbitration_Id(2))
...
def test_decode_with_too_big_dlc():
    ...
    frame = cm.frame_by_id(canmatrix.Arbitration_Id(4))
    try:
...
def test_decode_with_dbc_float():
    ...
    frame = cm.frame_by_id(canmatrix.Arbitration_Id(3))
    decoded = frame.decode(frameData)
